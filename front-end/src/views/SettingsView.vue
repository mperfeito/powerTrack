    ...
    <div class="settings-container flex-grow-1 p-5">
      <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="text-dark fw-bold">
          <i class="fas fa-cog me-2 icon-primary"></i> Settings
        </h2>
      </div>
      ...
      <div v-else class="settings-content">
        <div class="settings-card p-4 mb-4">
          <h5 class="text-dark mb-4">
            <i class="fas fa-user-circle me-2 icon-primary"></i> Profile Information
          </h5>
        ...
        <div class="settings-card p-4 mb-4">
          <h5 class="text-dark mb-4">
            <i class="fas fa-lock me-2 icon-primary"></i> Change Password
          </h5>
